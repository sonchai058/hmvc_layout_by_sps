...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        ### SBS KEN DEBUG แก้อัพโหลดภาษาไทย (แปลงเป็นภาษาไทย)###
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            //     $setPath = array();
            //     foreach ($path as $key => $value) {
            //         if (mb_detect_encoding($value) != 'ASCII' && $key != (COUNT($path) - 1)) {
            //             $value = (iconv("UTF-8", "windows-874//IGNORE", $value));
            //         }
        ...
        ### SBS KEN DEBUG แก้อัพโหลดภาษาไทย (แปลงเป็นภาษาเครื่อง)###
        // $file->name =  iconv("windows-874","UTF-8//IGNORE", $file->name);
        ### SBS KEN DEBUG แก้อัพโหลดภาษาไทย (แปลงเป็นภาษาเครื่อง)###
