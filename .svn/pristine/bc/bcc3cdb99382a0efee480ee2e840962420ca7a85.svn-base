...
// die(APP_BASE_URL.'file_upload/jbimages/');
// print_r(realpath( '../../../file_upload/module/jbimages')); die();
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' =>  str_replace(((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST'], '', APP_BASE_URL).'file_upload/jbimages/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => ('../../../../file_upload/jbimages/'),
